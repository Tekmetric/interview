"""
Distributed NEO Data Processor - fully parallel pipeline using Spark
"""
...
from .distributed_api_client import DistributedNASAAPIClient
from .distributed_data_processor import DistributedDataProcessor
...
class DistributedNEOPipeline:
    """
    Fully distributed NEO Data Processor using Spark for all operations
