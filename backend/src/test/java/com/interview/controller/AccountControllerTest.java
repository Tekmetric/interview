...
import com.interview.constants.CommonConstants;
...
import com.interview.service.account.IAccountOrchestrationService;
...
class AccountControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(accountController)
                .setControllerAdvice(new com.interview.exception.GlobalExceptionHandler())
                .build();
