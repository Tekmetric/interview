...
4. Demo API functionality using API client tool  
   - A Postman collection is provided: import `postman/Interview-API.postman_collection.json` into Postman (or Insomnia). It includes CRUD requests for Customers, Vehicles, and Work Orders; variables use seeded IDs so Get/Update/Delete work after startup.
