...
export async function fetchRandomBreweries(
  count: number = 4,
): Promise<Brewery[]> {
...
export async function searchBreweriesByQuery(
  query: string,
  limit: number = 10,
): Promise<Brewery[]> {
...
export async function fetchBreweriesAutocomplete(
  query: string,
  limit: number = 8,
): Promise<BreweryAutocomplete[]> {
