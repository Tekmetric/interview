// Tiny inline SVG icons — decorative only, so every icon is aria-hidden.
// The accessible name always comes from the surrounding control.
...
export function PortalIcon({ size = 20 }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      width={size}
