...
public class ShopResource {
	...
	public ShopResponse updateShop(@RequestBody @Valid ShopRequest shopRequest, @PathVariable Long shopId, BindingResult errors) {
		return shopService.updateShop(shopId, shopRequest, errors);
	}
}