...
CREATE TABLE estimate_work_orders (
    estimate_id UUID NOT NULL,
    work_order_id UUID NOT NULL,
    PRIMARY KEY (estimate_id, work_order_id),
    CONSTRAINT fk_estimate_work_orders_estimate FOREIGN KEY (estimate_id) REFERENCES estimates(id),
    CONSTRAINT fk_estimate_work_orders_work_order FOREIGN KEY (work_order_id) REFERENCES work_orders(id)
);
...
INSERT INTO work_orders (id, vehicle_id, status, summary, notes, labor_rate, labor_time, created_at, updated_at) VALUES
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '99999999-9999-9999-9999-999999999999', 'PENDING', 'Replace front brake pads', 'Pads are worn below recommended thickness.', 145.00, 1.50, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '99999999-9999-9999-9999-999999999999', 'ACCEPTED', 'Tune ignition and belt system', 'Customer approved spark plug and belt replacement.', 155.00, 2.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('cccccccc-cccc-cccc-cccc-cccccccccccc', '88888888-8888-8888-8888-888888888888', 'REFUSED', 'Replace front strut assemblies', 'Customer declined suspension work for now.', 135.00, 3.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('dddddddd-dddd-dddd-dddd-dddddddddddd', '77777777-7777-7777-7777-777777777777', 'PENDING', 'Perform oil service', 'Oil filter replacement as part of maintenance visit.', 150.00, 0.75, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('10000000-0000-0000-0000-000000000005', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '44444444-4444-4444-4444-444444444444', 1);
...
INSERT INTO estimate_work_orders (estimate_id, work_order_id) VALUES
