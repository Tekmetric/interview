...
1. API should include one object with create, read, update, and delete operations. Read should include fetching a single item and list of items.
1. Provide SQL create scripts for your object(s) in resources/data.sql
1. Demo API functionality using API client tool
