...
- [https://github.com/Tekmetric/interview.git](https://github.com/Tekmetric/interview.git)
...
1. Kubernetes Deployment:
    1. Develop Helm charts or standard Kubernetes manifests to deploy the application(s) on a K8s cluster.
    1. Application Enhancements: Ensure each application has appropriate health checks (e.g., liveness and readiness probes).
        - Add relevant metrics (e.g., Prometheus instrumentation) to monitor application performance.
1. Documentation: Provide clear instructions on how to build and deploy the application(s), including any prerequisites.
