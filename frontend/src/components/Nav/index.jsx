import {
  ...
  const handle = { hydrate: true };
  
  const solutions = [
    {
      name: "PRODUCT INSTRUCTIONS",
      description: "Installation instructions for our products..",
      href: "https://praxiscycles.com/tech-manuals",
      icon: NewspaperIcon,
    },
    {
      name: "COMPARISON OVERVIEW",
      description: "Speak directly to your customers in a more meaningful way.",
      href: "/pdf/MY22.23_OEM_OVERVIEW_RevH",
      icon: ChartSquareBarIcon,
    },
    {
      name: "OEM TERMS & CONDITIONS",
