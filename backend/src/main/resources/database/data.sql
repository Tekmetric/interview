...
('Pasta (Penne)', 'Grains', 2.0, 'kg', 15.0, 2.80, 'Italian Imports', '2026-03-31', false, CURRENT_TIMESTAMP()),
...
('Butter', 'Dairy', 4.0, 'kg', 5.0, 7.50, 'Dairy Delight', '2024-11-25', true, CURRENT_TIMESTAMP()),
