...
class WorkOrderControllerIntegrationTest {
    ...
    private static final String ADMIN_USER = "api-admin";
    private static final String ADMIN_PASSWORD = "changeit-admin";
    private static final String READONLY_USER = "api-user";
    private static final String READONLY_PASSWORD = "changeit-user";
    ...
    @Test
    void shouldRejectWhenNoCredentialsProvided() throws Exception {
        mockMvc.perform(get("/api/customers/1/work-orders"))
    ...
    @Test
    void shouldRejectWhenInvalidCredentialsProvided() throws Exception {
        mockMvc.perform(get("/api/customers/1/work-orders")
    ...
    @Test
    void shouldRejectWriteForReadonlyUser() throws Exception {
        Map<String, Object> payload = Map.of(
                "vin", "JH4KA9650MC012345",
                "issueDescription", "Oil change and filter",
                "status", "OPEN"
        ...
        mockMvc.perform(post("/api/customers/1/work-orders")
                        .with(httpBasic(READONLY_USER, READONLY_PASSWORD))
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(payload)))
    ...
    @Test
    void shouldAllowReadForReadonlyUser() throws Exception {
        mockMvc.perform(get("/api/customers/1/work-orders")
                        .with(httpBasic(READONLY_USER, READONLY_PASSWORD)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content.length()").value(3));
